...
Del 1 skrevet av: Heather Broomfield  og Øystein Åsnes (Difi) +
Bidragsytere: Øyvind Grinde, Livar Bergheim, Marta Kari Schawlann
...
"_Mål 3: Et velfungerende samspill om forvaltning, deling, utvikling og innovasjon mellom aktørene i offentlig og privat sektor_”
